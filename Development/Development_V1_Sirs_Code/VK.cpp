	...
	switch (iMsg)
	{
		...
		*/
		...
		case WM_KEYDOWN:
			...
			case 0x52: //R key 
				fprintf(gFILE, "WndProc() 0x52 pressed.\n");
...
VkResult initialize(void)
{
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "initialize(): CreateCommandBuffers() function failed with error code %d for 1024 x 1024 command buffer\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "initialize(): CreateCommandBuffers() succedded  for 1024 x 1024 command buffer\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "initialize(): CreateVertexBuffer() function failed with error code for 1024 x 1024 %d\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "initialize(): CreateVertexBuffer() succedded for 1024 x 1024\n");
	}
...
VkResult resize(int width, int height)
{
	...
	*/
	...
	if(vkCommandBuffer_for_1024_x_1024_graphics_array)
	{
		...
		fprintf(gFILE, "resize(): vkCommandBuffer_for_1024_x_1024_graphics_array is freed\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "resize(): CreateCommandBuffers() function failed with error code %d for 1024 x 1024\n", vkResult);
		return vkResult;
	}
...
VkResult display(void)
{
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "display(): buildCommandBuffers() function failed with error code %d\n", vkResult);
		return vkResult;
	}
		...
		if(vkDevice)
		{
			...
			*/
			if(vertexData_position_1024_x_1024_graphics.vkDeviceMemory)
			{
				...
				fprintf(gFILE, "uninitialize(): vertexData_position_1024_x_1024_graphics.vkDeviceMemory is freed\n");
			}
			...
			if(vertexData_position_1024_x_1024_graphics.vkBuffer)
			{
				...
				fprintf(gFILE, "uninitialize(): vertexData_position_1024_x_1024_graphics.vkBuffer is freed\n");
			}
			...
			if(vkCommandBuffer_for_1024_x_1024_graphics_array)
			{
				free(vkCommandBuffer_for_1024_x_1024_graphics_array);
				vkCommandBuffer_for_1024_x_1024_graphics_array = NULL;
				fprintf(gFILE, "uninitialize(): vkCommandBuffer_for_1024_x_1024_graphics_array is freed\n");
			}	
...
VkResult prepareSineWaveforCPU(unsigned int mesh_width, unsigned int mesh_height, float anim_Time)
{
	...
	*/
	...
	if( (mesh_width == 1024) && (mesh_height == 1024))
	{
		...
		if(vkResult != VK_SUCCESS)
		{
			fprintf(gFILE, "prepareSineWaveforCPU():vkMapMemory() failed\n");
		}
